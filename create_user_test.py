...
def test_create_user_english_letter_in_first_name_get_error_response():
    positive_assert("QWErty")

def test_create_user_russians_letter_in_first_name_get_success_response():
...
def test_create_user_numbers_symbol_in_first_name_get_error_response():
